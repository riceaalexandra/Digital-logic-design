...
-- \   \   \/     Version: J.40
--  \   \         Application: netgen
--  /   /         Filename: reg4_I_timesim.vhd
-- /___/   /\     Timestamp: Sun Apr 10 15:19:58 2022
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -s 4 -pcf reg4_I.pcf -rpw 100 -tpw 0 -ar Structure -tm reg4_I -insert_pp_buffers false -w -dir netgen/par -ofmt vhdl -sim reg4_I.ncd reg4_I_timesim.vhd 
-- Device	: 3s400ft256-4 (PRODUCTION 1.39 2007-10-19)
-- Input file	: reg4_I.ncd
-- Output file	: D:\laborator_6_partea_comuna_II\reg4_I\netgen\par\reg4_I_timesim.vhd
-- # of Entities	: 1
-- Design Name	: reg4_I
-- Xilinx	: C:\Xilinx92i
--             
...
architecture Structure of reg4_I is
...
begin
  ...
  NlwBlock_reg4_I_GND : X_ZERO
    port map (
      O => GND
    );
  NlwBlock_reg4_I_VCC : X_ONE
    port map (
      O => VCC
    );
  NlwBlockROC : X_ROC
